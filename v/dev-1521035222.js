...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {/*global require, global */
	
	global.initMatchPage = __webpack_require__(/*! ./init-match-page */ 1);
	global.initTestPage = __webpack_require__(/*! ./init-test-page */ 20);
...
/* 1 */
/*!************************************!*\
  !*** ./scripts/init-match-page.js ***!
  \************************************/
/***/ (function(module, exports, __webpack_require__) {

	/*global module, require,Promise*/
	
	var TankWarsModel = __webpack_require__(/*! ./tankwars-model */ 2),
		mapWidget = __webpack_require__(/*! ./tankwars-map-widget */ 11),
		tankStatusWidget = __webpack_require__(/*! ./update-tank-statuses */ 12),
		localStorageCacheWidget = __webpack_require__(/*! ./local-storage-cache-widget */ 13),
		skipTurnsWidget = __webpack_require__(/*! ./skip-turns-widget */ 14),
		ApiExecutor = __webpack_require__(/*! ./api-executor */ 15),
		packOptions = __webpack_require__(/*! ./pack-options */ 17),
		logWidget = __webpack_require__(/*! ./log-widget */ 18),
		promiseDelay = __webpack_require__(/*! ./promise-delay */ 19);
...
/* 2 */
/*!***********************************!*\
  !*** ./scripts/tankwars-model.js ***!
  \***********************************/
/***/ (function(module, exports, __webpack_require__) {

	/*global module, require */
	var makeEmitter = __webpack_require__(/*! ./mini-emit */ 3),
		uuid = __webpack_require__(/*! uuid */ 4),
		freeSpace = __webpack_require__(/*! ./free-space */ 6);
	module.exports = function TankWarsModel(args) {
		'use strict';
		var self = makeEmitter(this),
			options = args || {},
			mazeBuilder = options.mazeBuilder || __webpack_require__(/*! ./maze-builder */ 7),
			...
			randomizer = options.randomizer || __webpack_require__(/*! ./randomizer */ 8),
			walls = options.walls || [],
			tanks = options.tanks || [],
			mapWidth,
			matchId,
			...
			weaponRange,
			weaponDamage,
			growFire = options.growFire || __webpack_require__(/*! ./grow */ 10),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rng = __webpack_require__(/*! ./rng */ 5);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function grow(fieldList, width, height, options) {
		'use strict';
		var randomizer = (options && options.randomizer) || __webpack_require__(/*! ./randomizer */ 8),
			xdeltas = [-1, 0, 1],
			ydeltas = [-1, 0, 1],
			inMap = function (ob) {
...
/* 11 */
/*!****************************************!*\
  !*** ./scripts/tankwars-map-widget.js ***!
  \****************************************/
/***/ (function(module, exports) {
...
/* 12 */
/*!*****************************************!*\
  !*** ./scripts/update-tank-statuses.js ***!
  \*****************************************/
/***/ (function(module, exports) {
...
/* 13 */
/*!***********************************************!*\
  !*** ./scripts/local-storage-cache-widget.js ***!
  \***********************************************/
/***/ (function(module, exports) {
...
/* 15 */
/*!*********************************!*\
  !*** ./scripts/api-executor.js ***!
  \*********************************/
/***/ (function(module, exports, __webpack_require__) {

	/*global module, require, Promise */
	var promisingXhr = __webpack_require__(/*! ./promising-xhr */ 16);
...
/***/ })
/******/ ]);
//# sourceMappingURL=dev-1521035222.js.map